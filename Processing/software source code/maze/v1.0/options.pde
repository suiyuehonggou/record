...
void siteCondirm_Return() {
  int tSize = height / 20;
  textSize(tSize);
  if (mouseButton == LEFT && mouseX >= width / 1.2 && mouseY >= height / 1.1 && mouseX <= width / 1.2 + (2 * tSize + 1) && mouseY<= height / 1.1 + (tSize + 1)) {
     rowNum = tempRowNum;
    colNum = tempColNum;
    wallWeight = tempWallWeight;
    sideLength = tempSideLength;
    fill(227, 140, 0);
    text("确定", width / 1.2, height / 1.1, 2 * tSize + 1, tSize + 1);
  }
  if (mouseButton == LEFT && mouseX >= width / 1.1 && mouseY >= height / 1.1 && mouseX <= width / 1.1 + (2 * tSize + 1) && mouseY<= height / 1.1 + (tSize + 1)) {
    fill(227, 140, 0);
    text("返回", width / 1.2, height / 1.1, 2 * tSize + 1, tSize + 1);
    page = 0;
    menu();
  }
...
void siteRow() {
  ...
  if (mouseButton == LEFT && mouseX >= width / 30 && mouseY >= height / 9.4 && mouseX <= width / 30 + tSize + 1 && mouseY <= height / 9.4 + tSize + 1) {
    site();
    tempRowNum = 4;
    fill(255, 0, 0);
    text("4", width / 30, height / 9.4, tSize + 1, tSize + 1);
  }
  ...
  if (mouseButton == LEFT && mouseX >= width / 30 && mouseY >= height / 2.17 && mouseX <= width / 30 + 2 * tSize + 1 && mouseY <= height / 2.17 + tSize) {
    site();
    tempRowNum = 24;
    fill(255, 0, 0);
    text("24", width / 30, height / 2.17, 2 * tSize + 1, tSize + 1);
  }
...
void siteCol() {
  ...
  if (mouseButton == LEFT && mouseX >= width / 9 && mouseY >= height / 9.4 && mouseX <= width / 9 + tSize + 1 && mouseY <= height / 9.4 + tSize + 1) {
    site();
    tempColNum = 4;
    fill(255, 0, 0);
    text("4", width / 9, height / 9.4, tSize + 1, tSize + 1);
  }
  ...
  if (mouseButton == LEFT && mouseX >= width / 9 && mouseY >= height / 2.17 && mouseX <= width / 9 + 2 * tSize + 1 && mouseY <= height / 2.17 + tSize) {
    site();
    tempColNum = 24;
    fill(255, 0, 0);
    text("24", width / 9, height / 2.17, 2 * tSize + 1, tSize + 1);
  }
...
void siteWallWeight() {
  ...
  if (mouseButton == LEFT && mouseX >= width / 5.5 && mouseY >= height / 9.4 && mouseX <= width / 5.5 + tSize + 1 && mouseY <= height / 9.4 + tSize + 1) {
    site();
    tempWallWeight = 3;
    fill(255, 0, 0);
    text("3", width / 5.5, height / 9.4, tSize + 1, tSize + 1);
  }
...
void siteSideLength() {
  ...
  if (mouseButton == LEFT && mouseX >= width / 4 && mouseY >= height / 9.4 && mouseX <= width / 4 + tSize + 1 && mouseY <= height / 9.4 + tSize + 1) {
    site();
    tempSideLength = 7;
    fill(255, 0, 0);
    text("7", width / 4, height / 9.4, tSize + 1, tSize + 1);
  }
